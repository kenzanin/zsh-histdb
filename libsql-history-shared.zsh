...
#   - fzf tab-separated output parsing
...
# ------------------------------------------------------------------
# _histdb_fzf_extract_cmd — Extract command from fzf tab-separated output
#
# fzf --delimiter outputs lines with tab separator. First field is argv.
# Surrounded by quotes from SQL query. Strips them.
# ------------------------------------------------------------------
_histdb_fzf_extract_cmd() {
...
# ------------------------------------------------------------------
# _histdb_fzf_extract_field — Extract Nth field (1-based) from fzf output
# ------------------------------------------------------------------
_histdb_fzf_extract_field() {
