...
You will need ~curl~, ~jq~ and a running ~rqlite~ cluster.
...
You will need ~curl~, ~jq~ and a running ~rqlite~ cluster.
To load and activate history recording you need to source ~rqlite-history.zsh~ from your shell in your zsh startup files.
